...
for x in range(0, 6):
    for y in range(0,6):
        if(x == y and not "." in links[x][y]):
            links[x][y] = "northeast_115_" + links[x][y] + "_descending.html"
        elif(not "." in links[x][y]):
            links[x][y] = "northeast_115_" + links[x][y] + ".html"
...
for type in sorts:
    ...
    with open("northeast_115.csv", newline='') as csvfile:
    ...
    f = open("northeast_115_" + type + ".html", "w")
    f.write(htmlData)
    f.close()

    htmlData = header + "</div>\n<div style=\"width: 100%; display: table;\">\n\t<table style=\"width:100%\">\n\t\t<tr>\n\t\t\t<th class=\"number\"><a href=\"northeast_115_prominence.html\" class=\"number\">Number &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_name.html\" class=\"name\">Name &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_elevation.html\" class=\"elevation\">Elevation (ft) &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_prominence.html\" class=\"prominence\">Prominence (ft) &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_isolation.html\" class=\"isolation\">Isolation (km) &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_date.html\" class=\"date\">Date Climbed &#8645</a></th>\n\t\t\t<th><a href=\"northeast_115_location.html\" class=\"location\">State &#8645</a></th>\n\t\t"
    ...
    f = open("northeast_115_" + type + "_descending.html", "w")
    f.write(htmlData)
    f.close()
